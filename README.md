...
- **DELETE `/pr/:id`**: ลบใบขอซื้อโดยมีเงื่อนไข
  ...
  - **`User` (พนักงานทั่วไป):** สร้างใบ PR (POST) , ดูรายการใบ PR ของตัว (GET) , และลบใบ PR ของตัวเองในสถานะ Pending (DELETE)
  - **`Admin` (ฝ่ายจัดซื้อ):** สิทธิ์ในการเปลี่ยนสถานะเอกสารเป็น Approved หรือ Rejected ได้ (PATCH)
